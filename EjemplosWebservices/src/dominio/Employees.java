 ...
 */
public class Employees implements Comparable<Employees>,java.io.Serializable {
	...
	public Employees(int employeeId, Departments departments, Jobs jobs,
			...
			BigDecimal commissionPct, Set departmentses, Set employeeses,
			Set jobHistories) {
		this.employeeId = employeeId;
	...
	public String toString() {
		String cadena = /*"Department = " + departments.getDepartmentName() +*/ "Id = " + employeeId + ", Nombre = "
				+ firstName + ", Apellido = " + lastName + ", Salario = " + salary + "\n"; 
		return cadena;
	}

	/**
	 * Método que permite comparar dos empleados por su salario
	 */
	@Override
